...
export class AccessServicesComponent implements ApplicationPresenter, OnChanges, OnDestroy {
    ...
    onDigitalOutputClicked(signalID: string): void {
        console.log('Digital output clicked:', signalID);
        // Get current value and toggle it
        const currentSignal = this.signalStatusMap().get(signalID);
        const currentValue = currentSignal ? this.getBooleanValue(currentSignal.value) : false;
        const newValue = !currentValue;
        
        this.applicationAPI.sourceService.setSourceSignalValue("ur-robot-io", "ur-tool-io", signalID, {
            signalID: signalID,
